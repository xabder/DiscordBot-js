...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const channel = await interaction.guild.channels.create({
      name: `ansøgning-${username}`,
      type: ChannelType.GUILD_TEXT,
      parent: interaction.guild.channels.cache.find((channel) => channel.name === 'Admin Ansøgning'),
    });
    ...
    await channel.send({
      embeds: [
        {
          color: 0xff0000,
          title: 'Admin Ansøgning',
          description: `Hej ${interaction.user}, du kan sende din ansøgning her!`,
        },
      ],
      components: [
        {
